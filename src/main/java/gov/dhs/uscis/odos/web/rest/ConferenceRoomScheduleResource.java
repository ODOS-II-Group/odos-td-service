...
public class ConferenceRoomScheduleResource {
	 ...
	 *            the conferenceRoomScheduleDTO to create
	 * @return the ResponseEntity with status 201 (Created) and with body the new
	 *         conferenceRoomScheduleDTO, or with status 400 (Bad Request) if the
	 *         conferenceRoomSchedule has already an ID
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@PostMapping("/conference-room-schedule")
	@Timed
	public ResponseEntity<ConferenceRoomScheduleDTO> createConferenceRoomSchedule(
			@Valid @RequestBody ConferenceRoomScheduleDTO conferenceRoomScheduleDTO) throws URISyntaxException {
		log.debug("REST request to save ConferenceRoomSchedule : {}", conferenceRoomScheduleDTO);
		if (conferenceRoomScheduleDTO.getId() != null) {
			throw new BadRequestAlertException("A new conferenceRoomSchedule cannot already have an ID", ENTITY_NAME,
					"idexists");
		}
	 ...
	 *
	 * @param conferenceRoomScheduleDTO
	 *            the conferenceRoomScheduleDTO to update
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         conferenceRoomScheduleDTO, or with status 400 (Bad Request) if the
	 *         conferenceRoomScheduleDTO is not valid, or with status 500 (Internal
	 *         Server Error) if the conferenceRoomScheduleDTO couldn't be updated
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@PutMapping("/conference-room-schedule")
	@Timed
	public ResponseEntity<ConferenceRoomScheduleDTO> updateConferenceRoomSchedule(
			@Valid @RequestBody ConferenceRoomScheduleDTO conferenceRoomScheduleDTO) throws URISyntaxException {
	 ...
	 *         conferenceRoomSchedules in body
	 */
	 ...
	 *
	 * @param id
	 *            the id of the conferenceRoomScheduleDTO to retrieve
	 * @return the ResponseEntity with status 200 (OK) and with body the
	 *         conferenceRoomScheduleDTO, or with status 404 (Not Found)
	 */
	...
	/**
	 * GET /conference-room-schedule-today/:id : get the "id"
	...
	/**
	 * DELETE /conference-room-schedule/:id : delete the "id"
	 * conferenceRoomSchedule.
	 *
	 * @param id
	 *            the id of the conferenceRoomScheduleDTO to delete
	 ...
	 *         conferenceRoomScheduleDTO, or with status 404 (Not Found)
	 */
	@GetMapping("/conference-room-schedule-slot/{id}/{date}")
	@Timed
	public List<Integer> getBookedScheduledRoomTodayById(@PathVariable Long id, @PathVariable String date) {
