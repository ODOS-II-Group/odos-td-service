...
public class ConferenceRoomEquipmentMapperTest {
	...
	public void setup() {
		...
		Mockito.when(mapper.map(conferenceRoomEquipment, ConferenceRoomEquipmentDTO.class))
				.thenReturn(conferenceRoomEquipDTO);
		Mockito.when(mapper.map(conferenceRoomEquipDTO, ConferenceRoomEquipment.class))
				.thenReturn(conferenceRoomEquipment);
	}
	...
	public void testToEntity2() {
		ConferenceRoomEquipment entity = new ConferenceRoomEquipment();
		conferenceRoomEquipmentMapper.toEntity(conferenceRoomEquipDTO, entity);
